...
sunshichejiashiyuan_lipei=chesun[['损失车辆驾驶员','Claim ID']].drop_duplicates().rename(columns={'Claim ID':'Source','损失车辆驾驶员':'Target'})
...
edges = pd.concat([che_chezhu,che_toubao,che_beibaoren,che_lipei,jiashiyuan_lipei,sunshiche_lipei,sunshichejiashiyuan_lipei]).drop_duplicates()
...
for idx,sjl in sunshichejiashiyuan_lipei.iterrows():
